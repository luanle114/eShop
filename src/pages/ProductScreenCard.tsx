...
import { IStyledProductScreenCard } from '../components/ProductScreen/ProductScreenCard.style';
...
const ProductScreenCard = ({product}: any) => {
  ...
  const addToCartHandler = async () =>{
    const exstItem = cart.cartItems.find((x: any) => x._id === product._id);
  ...
  const addToWishHandler = async () =>{
    const exstItem = wish.wishItems.find((x:any) => x._id === product._id);
