...
import { IStyledPlaceOrder } from '../components/PlaceOrder/PlaceOrder.style';
...
const PlaceOrder = () => {
  ...
  const roundPrice = (num: any) => Math.round(num * 100 + Number.EPSILON) / 100;
  cart.itemsPrice = roundPrice(cart.cartItems.reduce((a: any, c: any) => a + c.quantity * c.price, 0));
